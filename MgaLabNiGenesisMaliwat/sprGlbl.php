...
if ($theme === "dark") {
    $bodyClass = "bg-cyan-500 text-amber-100";
    $cardClass = "bg-blue-900 border-yellow-400";
    $mutedText = "text-lime-200";
    $softBg    = "bg-cyan-900";
}
            ...
            <div class="grid md:grid-cols-2 gap-4 mt-6">
                ...
                <div class="<?= $softBg; ?> border <?= ($theme === "dark" ? "border-slate-700" : "border-slate-200"); ?> rounded-xl p-4">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="mt-4 space-y-3">
                        ...
                        <button class="w-full rounded-xl px-4 py-2 font-semibold <?= ($theme === "dark" ? "bg-cyan-500 text-white" : "bg-slate-900 text-white"); ?>">
                            Save (POST)
                        </button>
                    </form>
