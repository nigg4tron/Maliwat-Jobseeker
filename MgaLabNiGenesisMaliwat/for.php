<?php
     $names=["genesis", "lloyd", "dan"];


    $users=[
        ['name'=>'Genesis Maliwat', 'email'=>'ssaj2@gmail.com'],
        ['name'=>'Jan Nuary', 'email'=>'ssaj1@gmail.com'],
        ['name'=>'Ken Cruz', 'email'=>'ssaj3@gmail.com'],
        ['name'=>'Lloyd Frace', 'email'=>'ssaj4@gmail.com']
    ];
